...
app.post('/api/nombramientos/crear', async (req, res) => {
    ...
    try {
        ...
        res.status(201).json({ mensaje: 'Nombramiento creado y convocatorias abiertas con exito.' });
